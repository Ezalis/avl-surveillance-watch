...
- **Evanston, IL:** told to sign its 7-year, $5.8M renewal by December 12 **or pay 8% more (~$470K)** — a deadline discount as a substitute for deliberation. The "bodycam renewal" quietly grew to include fleet cameras, drones, and a real-time crime center. ([Daily Northwestern](https://dailynorthwestern.com/2025/12/10/top-stories/city-council-approves-5-8-million-body-camera-police-technology-contract-with-axon-enterprise/))
- **And it's recruiting here now:** Brevard is currently weighing an Axon offer of **three "free" LPR cameras** bundled into an ~$80K five-year package — the sweetener-then-flywheel sequence, one county over. ([[Transylvania County]])
...
Translate: the footage and data Asheville's taxpayers fund — bodycams, in-car video, the RTIC's feeds — is, by contract default, raw material for the vendor's future product line. The city can revoke Tier 1 at any time in writing. So the questions for APD are a records request away, and they're yes-or-no: **Has Asheville revoked ACEIP Tier 1? Is the Tier 2 box checked?** If nobody at the city can answer, that *is* the answer — default terms govern, and the default is enrolled. ([[Documents]] request list · primary text: Axon MSPA v24, ACEIP Appendix — same baseline as the [public Durham copy](https://www.axon.com/legal/master-services-and-purchasing-agreement))
