...
There it is, from the chief and a councilmember jointly: the camera is a token; the product is the account. And Bo Hess, arguing *for* the plan, added the expiration logic [(43:23)](https://www.youtube.com/watch?v=I0PFVrO9CRQ&t=2603s): "even if Asheville got rid of every single Flock camera in Asheville, there would still be Flock cameras that you would be in contact with all over Western North Carolina... **until Axon has the type of database that we can access like Flock**, keeping that one Flock camera is a strategic public safety move." Read the condition: Flock exits when Axon replicates the network — when the *vendor* changes, not when the surveillance ends. The full mechanics and the four-part motion that actually ends it: [[Getting Flock Out]].

For the ledger, the counts as stated here [(44:41)](https://www.youtube.com/watch?v=I0PFVrO9CRQ&t=2681s): the city owns **11** Flock cameras, the county **22**, and there are "many, many more in the city of Asheville" privately owned. Remember these small numbers next time the network is described as tiny — the same briefing insisted access to *everyone else's* cameras was "imperative," and fourteen months earlier the [[2025-03-07 Agenda Briefing|figure offered was 177,000]].
