...
Buncombe County Schools became the first WNC district on Fusus in **late 2021, via a memorandum of understanding with the Sheriff's Office**. Roughly **1,500 cameras across 43+ schools** feed the network; the district says it controls when deputies get access. What we cannot find: **any public school-board vote on the MOU, the MOU's text, any parent-notification record, or any board policy governing it** — and no board agenda has revisited camera access since national reporting showed [ICE tapping school camera networks elsewhere](https://www.the74million.org/article/ice-taps-into-school-security-cameras-to-aid-trumps-immigration-crackdown-74-investigation-shows/). (Sheriff Miller has publicly barred ICE from schools without a court order — a personal commitment, not a policy that survives him; he's on the November ballot, and so are three school-board seats.) These are the region's premier records-request targets.
